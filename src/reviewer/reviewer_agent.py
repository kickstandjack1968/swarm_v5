### FILE: src/reviewer/reviewer_agent.py ###
#!/usr/bin/env python3
import sys
import json
import requests
            ...
            response = requests.post(
                ...
                json={
                    ...
                    "options": {
                        ...
                        "num_predict": config.get("max_tokens", 3000),
                    }
                },
                timeout=timeout
            )
...
def main():
    try:
        # Read full input payload
        input_data = json.load(sys.stdin)
        
        # Extract configuration and prompts provided by the coordinator
